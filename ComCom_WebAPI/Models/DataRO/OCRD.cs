...
namespace ComCom_WebAPI.DataRO
{
    public partial class OCRD
    {
        ...
        public string? U_BuroCredito { get; set; }
        public string? U_IdTarjeta { get; set; }
        public string? U_Puntos { get; set; }
        public string? U_FechaTarjeta { get; set; }
        public decimal? U_CS_DESCUENTO { get; set; }
        public string? U_BTS_SAT_Cuenta { get; set; }
        public string? U_Ref_Bancomer { get; set; }
        public string? U_Ref_Banamex { get; set; }
        public string? U_Clasificacion { get; set; }
        public string? U_RefSantander { get; set; }
        public string? U_U_Email_Adicional { get; set; }
        public string? U_Pagare { get; set; }
        public DateTime? U_FechaV { get; set; }
        public string? U_CUniversal { get; set; }
        public string? U_CLABECU { get; set; }
        public string? U_B1SYS_MainUsage { get; set; }
        public string? U_Juridico { get; set; }
        public string U_SO1_02ADDENDA { get; set; } = null!;
        public string U_SO1_02ADDCONF { get; set; } = null!;
        public string U_SO1_02COMPLEMENTO { get; set; } = null!;
        public string U_SO1_02DESGLOSAIEPS { get; set; } = null!;
        public string? U_BD_Erst { get; set; }
        public string? U_BD_Datev { get; set; }
        public decimal? U_ImportePagare { get; set; }
        public string? U_SO1_01SUCURSAL { get; set; }
        public string U_SO1_01AUTORIZARCOM { get; set; } = null!;
        public string? U_SO1_01CLIENTBLOQ { get; set; }
        public string U_SO1_01VENCREVENC { get; set; } = null!;
        public string? U_SO1_01METODOPAGO { get; set; }
        public string? U_SO1_01NUMCTAPAGO { get; set; }
        public string? U_SO1_01BASEDATOS { get; set; }
        public string U_SO1_01ADDENDA { get; set; } = null!;
        public int? U_SO1_01FACTORCOMPRA { get; set; }
        public int? U_SO1_01NUMLINEASCOM { get; set; }
    }
}
