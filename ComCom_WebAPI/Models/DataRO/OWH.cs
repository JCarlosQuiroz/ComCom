...
namespace ComCom_WebAPI.DataRO
{
    public partial class OWH
    {
        ...
        public string? U_BONIFICACION { get; set; }
        public string? U_FLETES { get; set; }
        public string? U_ANTICIPO { get; set; }
        public string? U_CORTES { get; set; }
        public string? U_FACTRESERVA { get; set; }
        public string? U_INTMORAT { get; set; }
        public string? U_PAGOTARJETA { get; set; }
        public string? U_RENTAS { get; set; }
        public int? U_PreciosR { get; set; }
        public string? U_SO1_02LUGEXPEDIC { get; set; }
        public int? U_PreciosP { get; set; }
        public string U_SO1_01ALMACENCOLEC { get; set; } = null!;
