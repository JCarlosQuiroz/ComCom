import { ConstrainMode, DetailsList, DetailsListLayoutMode, IColumn, IImageProps, ImageFit, Stack,Image } from '@fluentui/react';
...
export default CuartoFrioTomateFrello;
