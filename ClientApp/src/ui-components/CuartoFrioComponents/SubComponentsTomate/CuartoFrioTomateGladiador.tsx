...
// import {  urlGetTomateGladiador } from '../../../services/endpoints';
...
export class CuartoFrioTomateGladiador extends React.Component<{}, ICuartoFrioState> {
    async componentDidMount() {
        const response = await axios.get('https://localhost:44394/api/GetTomateGladiador');
...
export default CuartoFrioTomateGladiador;
