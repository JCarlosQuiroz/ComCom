import { ConstrainMode, DetailsList, DetailsListLayoutMode, IColumn, IImageProps, Image, ImageFit, Stack } from '@fluentui/react';
import axios from 'axios';
import { Images, Theme } from '../../../styles/Theme'
import * as React from 'react';
// import {  urlGetTomateSunset } from '../../../services/endpoints';
import { ICuartoFrioState } from '../../../models/Productos';

const imageProps: Partial<IImageProps> = {
    imageFit: ImageFit.cover,
    src: Images.sunsetLogo,
    alt: 'sunset',
    style: {
      width: '120px',
      height: 'auto',
...
export class CuartoFrioTomateSunset extends React.Component<{}, ICuartoFrioState> {
    async componentDidMount() {
        const response = await axios.get('https://localhost:44394/api/GetTomateSunset');
...
export default CuartoFrioTomateSunset;
