...
export class DocumentsLists extends React.Component<{}, IDetailsListDocumentsExampleState> {
    ...
    return (
      <div>
        <div className={classNames.controlWrapper}>
          <Toggle
            label="Habilitar el modo compacto"
        ...
        //    onChange={this._onChangeCompactMode}
          ...
          />
          <Toggle
            label="Habilitar la selección modal"
            ...
            styles={controlStyles}
          />
          <TextField label="Filtrar por nombre:" /*onChange={this._onChangeText}*/ styles={controlStyles} />
  ...
  private _getSelectionDetails(): string {
    ...
    switch (selectionCount) {
      case 0:
        return 'No se seleccionaron elementos';
      case 1:
        return '1 artículo seleccionado: ' + (this._selection.getSelection()[0] as IDocument).name;
      default:
        return `${selectionCount} artículo seleccionado`;
    }
  }
